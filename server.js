...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Nishi house'},
        { title: 'another event', id: 2, description: 'something even cooler', location: 'Nishi office' }
    ]
};
